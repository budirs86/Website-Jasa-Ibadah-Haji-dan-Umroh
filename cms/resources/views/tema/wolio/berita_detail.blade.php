                                    ...
                                    <div class="section-tittle col-md-12">
                                        <ul>
                                            <p>
                                                ...
                                                <a href="https://www.facebook.com/sharer/sharer.php?u={{ env('APP_URL').'/'.'berita_detail/'.$berita->slug }}" target="_blank">
                                                    <img src="{{ asset('assets/icon/facebook-new.png')}}" alt="Facebook share link" />
                                                </a>
                                                <!-- LinkedIn Social Media -->
                                                <a href="https://www.linkedin.com/shareArticle?mini=true&amp;url={{ env('APP_URL').'/'.'berita_detail/'.$berita->slug }}" target="_blank">
