...
<span class="info-box-text">INDEK KEPUASAN MASYARAKAT</span>
...
<div class="info-box-content">
<span class="info-box-text">JUMLAH RESPONDEN</span>
...
<div class="info-box-content">
<span class="info-box-text">QUESTIONER</span>
...
<h3 class="card-title">Statistik Berdasarkan Jawaban</h3>
...
<thead>
    <tr>
        ...
        <th width="40%" rowspan="2">Pertanyaan</th>
        <th colspan="4" width="55%"><center>Jawaban</center></th>
    </tr>
    <tr>
...
<div class="card-header">
<h3 class="card-title">Statistik Responden Berdasarkan Pendidikan</h3>
<div class="card-tools">
<button type="button" class="btn btn-tool" data-card-widget="collapse">
<i class="fas fa-minus"></i>
</button>
...
<div class="card card-danger">
<div class="card-header">
<h3 class="card-title">Statistik Responden Berdasarkan Pekerjaan</h3>
<div class="card-tools">
<button type="button" class="btn btn-tool" data-card-widget="collapse">
<i class="fas fa-minus"></i>
</button>
