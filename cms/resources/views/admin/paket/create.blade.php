        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="card card-info">
              ...
              @endif
              <!-- form start -->
              <form class="form-horizontal" action="{{ route('paket_store') }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input name="harga" class="form-control" required type="number" id="harga">
                    </div>
                  </div>
                  <div class="form-group row">
