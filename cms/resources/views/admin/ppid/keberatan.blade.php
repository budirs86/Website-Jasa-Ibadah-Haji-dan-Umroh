  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Daftar Pengajuan Keberatan</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <table id="halaman" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ $item->alasan }}</td>
                  <td>{{ $item->nama }}</td>
                  <td>{{ $item->unit_id_tujuan }}</td>
                  <td>{{ $item->status }}</td>
                  <td>
                    <a href="{{ route('dokumen_permohonan_keberatan_detail', $item->id) }}" class="btn btn-xs btn-primary">Detail</a>
                    <a href="{{ route('dokumen_permohonan_keberatan_destroy', $item->id) }}" class="btn btn-xs btn-danger">Hapus</a>
                  </td>
                </tr>
                @php
                    $i++;
