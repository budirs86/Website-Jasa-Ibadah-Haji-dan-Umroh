          ...
          <div class="col-md-12">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Front Menu</h3>
              </div>
              <!-- /.card-header -->
              @if ($errors->any())
              ...
              @endif
              <!-- form start -->
              <form class="form-horizontal" action="{{ route('front_detail_store') }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="card-body">
                <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="number" name="urut" class="form-control" id="inputEmail3" placeholder="Urut">
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
