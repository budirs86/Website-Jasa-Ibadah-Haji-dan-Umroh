              ...
              <form class="form-horizontal" action="{{ route('file_update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="title" class="form-control"  placeholder="Judul" value="{{ $file->title }}">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <a href="{{ asset('files/'.$file->file_name)}}" download class="btn btn-sm">{{ $file->file_name }}</a><br>
                    </div>
                  </div>
                  <div class="form-group row">
