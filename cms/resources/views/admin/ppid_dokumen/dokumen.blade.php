      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-header">
            <a href="{{ route('dokumen_create') }}" class="btn btn-sm btn-primary float-right btn-flat">Tambah dokumen</a>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <table id="halaman" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ $item->download }}</td>
                  <td>
                    <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('dokumen_destroy', $item->id) }}" method="POST">
                      <a href="{{ route('dokumen_edit', $item->id) }}" class="btn btn-xs btn-primary">Edit</a>
                      @csrf
                      @method('DELETE')
