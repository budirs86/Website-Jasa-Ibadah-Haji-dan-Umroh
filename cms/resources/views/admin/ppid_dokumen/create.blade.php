          ...
          <div class="col-md-12">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Dokumen PPID</h3>
              </div>
              <!-- /.card-header -->
              @if ($errors->any())
              ...
              @endif
              <!-- form start -->
              <form class="form-horizontal" action="{{ route('dokumen_store') }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="card-body">
